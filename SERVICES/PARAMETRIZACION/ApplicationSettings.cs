...
namespace SERVICIOS
{
	public class ApplicationSettings
	{
        ...
        public readonly string connAplicacionDB = @"Data Source=.\SQLEXPRESS;Initial Catalog=VolandoEshop;Integrated Security=True";

        ////SERVICES CLOUD DATABASE
        public readonly string connSeguridadDB = @"Data Source=.\SQLEXPRESS;Initial Catalog=Seguridad;Integrated Security=True";
        ...
        //public readonly string CurrentApi = "http://volandoapi.somee.com";
